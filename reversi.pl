...
coupValide(Grille, Coord, Camp):-
    ...
    caseDeGrille(NColSuiv, NLigne, Grille, CaseCote), campAdv(Camp, CaseCote), getListeDepl([NCol,NLigne], [NColSuiv,NLigne], L),
    changementPion(Grille, L, CaseCote);
    coordonneesOuListe(NCol, NLigne, Coord), caseDeGrille(NCol, NLigne, Grille, CaseCoup), vide(CaseCoup), succCol(NColSuiv, NCol),
    caseDeGrille(NColSuiv, NLigne, Grille, CaseCote), campAdv(Camp, CaseCote), getListeDepl([NCol,NLigne], [NColSuiv,NLigne], L),
    changementPion(Grille, L, CaseCote);
    coordonneesOuListe(NCol, NLigne, Coord), caseDeGrille(NCol, NLigne, Grille, CaseCoup), vide(CaseCoup), succCol(NCol, NColSuiv),
    succLigne(NLigne, NLigneSuiv), caseDeGrille(NColSuiv, NLigneSuiv, Grille, CaseCote), campAdv(Camp, CaseCote),
    getListeDepl([NCol,NLigne], [NColSuiv,NLigneSuiv], L), changementPion(Grille, L, CaseCote);
    coordonneesOuListe(NCol, NLigne, Coord), caseDeGrille(NCol, NLigne, Grille, CaseCoup), vide(CaseCoup), succCol(NCol, NColSuiv),
    succLigne(NLigneSuiv, NLigne), caseDeGrille(NColSuiv, NLigneSuiv, Grille, CaseCote), campAdv(Camp, CaseCote),
    getListeDepl([NCol,NLigne], [NColSuiv,NLigneSuiv], L), changementPion(Grille, L, CaseCote);
    coordonneesOuListe(NCol, NLigne, Coord), caseDeGrille(NCol, NLigne, Grille, CaseCoup), vide(CaseCoup), succCol(NColSuiv, NCol),
    succLigne(NLigne, NLigneSuiv), caseDeGrille(NColSuiv, NLigneSuiv, Grille, CaseCote), campAdv(Camp, CaseCote),
    getListeDepl([NCol,NLigne], [NColSuiv,NLigneSuiv], L), changementPion(Grille, L, CaseCote);
    ...
    caseDeGrille(NCol, NLigneSuiv, Grille, CaseCote), campAdv(Camp, CaseCote), getListeDepl([NCol,NLigne], [NCol,NLigneSuiv], L),
    changementPion(Grille, L, CaseCote);
...
getColonneBH([X,1], [[X,Y1]|L]):- succLigne(Y2, Y1), getLigneGD([X,Y2], L).
